...
public interface ComparitveCollectionUpdateHandler {
    ...
    default <S extends IdentifiableCollectionItem,T extends IdentifiableCollectionItem> List<T> comparativelyUpdateCollectionFields(ComparisonConfigDto comparisonConfig){
        ...
        // If no updates were made to collection field, then the new collection field value will be null!
        if(_new!=null) {
